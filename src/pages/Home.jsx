...
const Home = () => {
	...
	return (
		<main className="home-page">
			<img src="/6.-webshop/public/logo.png" alt="Switch Again Logo" className="hero-logo" />
			...
			<img src="/6.-webshop/public/sw2.png" alt="Nintendo Switch 2 Announcement" className="ns2-img" />
